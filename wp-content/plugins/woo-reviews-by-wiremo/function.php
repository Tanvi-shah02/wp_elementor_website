...
Plugin Name: Product & Site Reviews by Wiremo
...
Product & Site Reviews by Wiremo is free software: you can redistribute it and/or modify
it under the terms of the GNU General Public License as published by
the Free Software Foundation, either version 3 of the License, or
(at your option) any later version.

WooCommerce reviews plugin by Wiremo is distributed in the hope that it will be useful,
    ...
    if (current_user_can('administrator')) {
        ...
        <div class="wrap wiremo-full-container">
            ...
            <div style="display:none" id="nonceWiremo_send_completed_orders"><?php echo wp_create_nonce('wiremo_send_completed_orders');?></div>
                <h1><?php echo __("WooCommerce Reviews plugin by Wiremo","wiremo-widget"); ?></h1>
                <?php
