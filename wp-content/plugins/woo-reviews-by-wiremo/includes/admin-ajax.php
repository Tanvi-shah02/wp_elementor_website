        ...
        function wrpw_reset_old_identifiers() {
            ...
            if(isset($_POST["wiremoIdentifiers"])) {
                ...
                for($j=0;$j<count($wrpw_ids_resets);$j++) {
                    ...
                    if ($post_type == "product") {
                        if (get_post_meta($wrpw_ids_resets[$j], 'wrmr-review-total')) {
                            delete_post_meta($wrpw_ids_resets[$j], 'wrmr-review-total');
                        }
                        if (get_post_meta($wrpw_ids_resets[$j], 'wrmr-review-average')) {
                            delete_post_meta($wrpw_ids_resets[$j], 'wrmr-review-average');
                        }
                        if (get_post_meta($wrpw_ids_resets[$j], 'wrmr-review-count')) {
                            delete_post_meta($wrpw_ids_resets[$j], 'wrmr-review-count');
                        }
                    }
                }
            }
